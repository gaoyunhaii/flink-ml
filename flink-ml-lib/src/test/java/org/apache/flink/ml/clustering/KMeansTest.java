...
public class KMeansTest extends AbstractTestBase {
    ...
    private static void verifyClusteringResult(
        ...
        for (List<Integer> group : groups) {
            for (int i = 1; i < group.size(); i++) {
                ...
                assertEquals(
                        clusterIdByPoints.get(DATA.get(0)), clusterIdByPoints.get(DATA.get(idx)));
            }
        }
    }
    ...
    public void testParam() {
        ...
        assertEquals("euclidean", kmeans.getDistanceMeasure());
    ...
    public void testSaveLoadAndPredict() throws Exception {
        ...
        KMeansModel loadedModel = KMeansModel.load(path);
    ...
    public void testSetModelData() throws Exception {
        ...
        KMeansModel modelB = new KMeansModel();
        ReadWriteUtils.setStageParams(modelB, modelA.getParamMap());
        modelB.setModelData(modelData);
