...
public final class RecordBasedFeedbackChannel<T> implements FeedbackChannel<T> {
    ...
    public RecordBasedFeedbackChannel(SubtaskFeedbackKey<T> key) {
        this(key, new LockFreeBatchFeedbackQueue<>());
    }

    public RecordBasedFeedbackChannel(SubtaskFeedbackKey<T> key, FeedbackQueue<T> queue) {
